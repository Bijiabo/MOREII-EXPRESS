...
var reDraw = function(){
    ...
    context.clearRect(0,0,660,580);
    context.fillStyle = MoreiiCustom.cache.backgroundColor;
    context.fillRect(0,0,660,580);
    ...
    var bgPositionLeft = $('#canvas').offset().left%660;
    $('#wall').css({
...
//    context.fillRect(0,0,canvas.width,canvas.height);
    ...
    for(var i=0;i<paper.width;i++){
        for(var j=0;j<paper.height;j++){
            paperContext.drawImage(canvas,i*size/ 2.54 * 300 ,j*sizeHeight/ 2.54 * 300 );
        }
    }
